...
class MITLoader(Dataset):
    ...
    def __init__(self, csv_file, transforms: None) -> None:
        ...
        # 그럼 바로 인코딩 드간다.
            ...
            # 또한 TP_encoder로 인코딩 시, 첫 열과 둘째 열에 tau와 g 값이 추가되기 때문에 이것도 제거해야 한다!!!
    ...
    def __getitem__(self, item):
        # signal = self.annotations[item, :-1] # 마지막꺼 빼고 집어넣기 : 여긴 데이터셋이 달라져야 하니 수정 필요함, tau와 g를 없애기 위해 2:-1로 해야 할 듯
